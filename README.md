...
| `npm test` | Run the scoring-engine test suite (71 tests) |
...
src/
  domain/
    ...
    scoring.ts          The scoring engine — handicaps, Stableford, counting rounds, validation
    scoring.test.ts     71 tests, incl. the club-validated 13×3 handicap table
  data/
