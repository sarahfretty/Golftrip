...
export const PLAYERS: Player[] = [
  ...
  player("mark", "Mark", "Mark Davies", "M", "yellow", 7.3),
  player("paul", "Paul", "Paul Davies", "M", "yellow", 8.5),
  player("jim", "Jim", "Jim Campbell", "M", "yellow", 12.5),
  player("chris", "Chris", "Chris Harrod", "M", "yellow", 14.8),
  // Ladies — red
  player("sarah", "Sarah", "Sarah Barlow", "F", "red", 10.3, { organiser: true }),
  player("jane", "Jane", "Jane Davies", "F", "red", 12.7, { organiser: true }),
  player("nicky", "Nicky", "Nicky Harrod", "F", "red", 15.1),
  player("kathy", "Kathy", "Kathy Houseman", "F", "red", 23.1, { lockedGroup: LOCKED }),
  player("jo-irving", "Jo I", "Jo Irving", "F", "red", 23.7),
  player("debs", "Debs", "Debs Dugher", "F", "red", 24.9, { lockedGroup: LOCKED }),
  player("jo-campbell", "Jo C", "Jo Campbell", "F", "red", 34.9),
  player("catherine", "Catherine", "Catherine Bailey", "F", "red", 39.7, { lockedGroup: LOCKED }),
